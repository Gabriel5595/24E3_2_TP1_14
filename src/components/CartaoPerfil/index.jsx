...
export default function GaleriaImagens() {
  ...
  return (
    <div className="cartao-perfil">
      ...
      />
      <h1 className="cartao-perfil-titulo">Nome do Usuário</h1>
      <p className="cartao-perfil-descricao">
        Esta é uma breve biografia do usuário. Adicione informações relevantes
        aqui para que os visitantes possam conhecer melhor o perfil.
      </p>
    </div>
  );
};
